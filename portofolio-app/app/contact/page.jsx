          ...
          <div className="xl:h-[54%] order-2 xl:order-none">
            <form action="" className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl ">
              ...
              <p className="text-white/60">
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Animi vero sapiente nostrum veniam atque fugiat. Odio ullam officia quod veniam quasi, est, tenetur dignissimos minima, temporibus similique eos fugit architecto?
              </p>
